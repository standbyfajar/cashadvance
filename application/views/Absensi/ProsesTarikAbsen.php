          ...
          <?php $this->load->view('topnav'); ?>
           ...
           <div class="right_col" role="main">
							...
							<div class ="container-fluid">
								<form class="form-horizontal" name="formbook" enctype="multipart/form-data" action="<?php echo base_url('CabsenTarik/') ?> " method="POST" >
								
								<div class="col-md-12">
								<!-- panel pertama -->
								<div class="panel panel-primary">
								<div class="panel-heading"><i class="glyphicon glyphicon-cog "></i> Proses Tarik Absen</div>
								<div class="panel-body">
									...
									<div class="col-sm-6">
										...
										<div class="col-sm-4">
												<button type="submit" class="btn btn-danger" role="button"><span class="fa fa-cloud-download "></span> Proses</button>
											</div>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-12">
									<div class="panel panel-primary">
										<div class="panel-heading">Attendance Correction</div>
										<div class="panel-body">
										<table class="table" id="tbl_att">
												<thead>
												<tr>
													<th>Nik</th>
													<th>Nama Karyawan</th>
