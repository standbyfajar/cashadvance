			        ...
			        <div class="col-sm-12" role="main">
								...
								<div class="container" style="width: 60% ; ">
									...
									<div class="panel panel-info">
										<div class="panel-heading">Formulir Edit Grup Baru</div>
									...
									<div class="panel-body">
										...
										<?php } ?>
										<!-- awal pembuatan form -->
										<form class="form-horizontal" action="<?php echo base_url('Cgrup/update2') ?>" method="POST" name="formbook" enctype="multipart/form-data">
