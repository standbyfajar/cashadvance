						...
						<div class="col-sm-12">
								...
								<div class="panel panel-info">
									...
									<div class="panel-body">
												...
												<?php } ?>
												<!-- awal pembuatan form -->
										<form class="form-horizontal" action="<?php echo base_url('Cashadvance/update_admin') ?>" method="POST" name="formbook" enctype="multipart/form-data">

										<div class="form-group">
											<label class="col-sm-2 control-label">Id Admin Login</label>
											<div class="col-sm-2">
											<input type="text" name="id" id="id" value="<?php echo $dtadmin->id_admin; ?>" readonly>
											<input type="hidden" name="idold" id="id" value="<?php echo $dtadmin->id_admin; ?>" >
										</div></div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Nama karyawan</label>
											<div class="col-sm-2">
											<input type="text" name="nama" id="nama" value="<?php echo $dtadmin->nama_karyawan; ?>">
										</div></div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Username</label>
											<div class="col-sm-2">
											<input type="text" name="user" id="user" value="<?php echo $dtadmin->username; ?>">
										</div></div>
										<div class="form-group">
											<label class="col-sm-2 control-label">password</label>
											<div class="col-sm-2">
											<input type="text" name="pass" id="pass" value="<?php echo $dtadmin->password; ?>">
										</div></div>
										<div class="form-group">
											<label class="col-sm-2 control-label">jabatan </label>
											<div class="col-sm-2">
											<input type="text" name="jbt" id="jbt" value="<?php echo $dtadmin->jabatan; ?>">
										</div></div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
											<input type="text" name="akses" id="akses" value="<?php echo $dtadmin->hak_akses; ?>">
										</div></div>
