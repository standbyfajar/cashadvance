...
<body class="nav-md">
           ...
           <div class="right_col" role="main">
						...
						<div class ="container-fluid">
							<form class="form-horizontal" name="formbook" enctype="multipart/form-data" action="<?php echo base_url('Pinjam/act_preview') ?> " method="POST" >
								...
								<div class="panel-heading"><i class="glyphicon glyphicon-cog "></i> Laporan Perbulan</div>
 ...
 -->
							...
							<a href="<?php echo base_url('Pinjam/list_penjualan_pdf'); ?>" type="button" class="btn btn-success">Print PDF</a>
							<?php } ?>
