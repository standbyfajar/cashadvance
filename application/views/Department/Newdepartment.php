			        ...
			        <div class="right_col" role="main">
							...
							<div class="container" style="width: 60% ; ">
								...
								<div class="panel-body">
									...
									<?php } ?>
									<!-- awal pembuatan form -->
									<form class="form-horizontal" action="<?php echo base_url('CDepartment/savedepart') ?>" method="POST" name="formbook" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
											<input type="text" name="nama" placeholder="isi nama Department... " required>
										</div></div>
