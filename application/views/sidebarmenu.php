          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo $this->session->userlogin['nama']; ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('Cashadvance/home') ?>">Dashboard</a></li>
                      
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('Cashadvance/karyawan'); ?>">Karyawan</a></li>
                      <!-- <li><a href="<?php echo base_url('Pinjam/index'); ?>">Cash Advance</a></li> -->
                      <li><a href="<?php echo base_url('Cashadvance/departmen'); ?>">Department</a></li>
                      <li><a href="<?php echo base_url('Cashadvance/admin'); ?>">Admin</a></li>   
                    </ul>
                  </li>
